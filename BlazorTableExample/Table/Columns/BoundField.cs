...
public class BoundField<TGridItem, TProp> : ColumnBase<TGridItem>, ISortBuilderColumn<TGridItem>
{
    ...
    protected override void OnParametersSet()
    {
        ...
        if (HeaderText is null && Property.Body is MemberExpression memberExpression)
        {
            HeaderText = memberExpression.Member.Name;
        }
    }
